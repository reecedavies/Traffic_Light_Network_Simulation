...
namespace TrafficLight
{
    public partial class FormTrafficLight : Form
    {
        ...
        private void UpdateCounters(String command)
        {
            ...
            southCarCounter = Convert.ToInt32(splitString[6]);
            eastCarCounter = Convert.ToInt32(splitString[8]);
            northCarCounter = Convert.ToInt32(splitString[5]);
            westCarCounter = Convert.ToInt32(splitString[7]);
        ...
        {          
            ...
            sendString("Car,bottom left south," + southCarCounter, textBoxLightIP.Text);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Send string to server
            sendString("Car,bottom left west," + westCarCounter, textBoxLightIP.Text);
        }
