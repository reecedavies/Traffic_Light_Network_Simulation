...
namespace TrafficLight
{
    public partial class FormTrafficLight : Form
    {
        ...
        private void UpdateCounters(String command)
        {
            ...
            southCarCounter = Convert.ToInt32(splitString[10]);
            eastCarCounter = Convert.ToInt32(splitString[12]);
            northCarCounter = Convert.ToInt32(splitString[9]);
            westCarCounter = Convert.ToInt32(splitString[11]);
        ...
        private void buttonCarArrived_Click(object sender, EventArgs e)
        {
            ...
            sendString("Car,top right north," + northCarCounter, textBoxLightIP.Text);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Send string to server
            sendString("Car,top right east," + eastCarCounter, textBoxLightIP.Text);
        }
