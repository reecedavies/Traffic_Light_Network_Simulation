...
namespace TrafficLight
{
    public partial class FormTrafficLight : Form
    {
        ...
        private void UpdateCounters(String command)
        {
            ...
            southCarCounter = Convert.ToInt32(splitString[14]);
            eastCarCounter = Convert.ToInt32(splitString[16]);
            northCarCounter = Convert.ToInt32(splitString[13]);
            westCarCounter = Convert.ToInt32(splitString[15]);
        ...
        private void buttonCarArrived_Click(object sender, EventArgs e)
        {
            ...
            sendString("Car,bottom right south," + southCarCounter, textBoxLightIP.Text);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Send string to server
            sendString("Car,bottom right east," + eastCarCounter, textBoxLightIP.Text);
        }
